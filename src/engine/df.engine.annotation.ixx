...
// 支持多种导出格式：YOLO、VOC XML、COCO JSON、DeepForge 内部 JSON
module;
...
export module df.engine.annotation;
...
// ============================================================================
// 20260320 ZJH 保存标注到 DeepForge 内部 JSON 格式
// ============================================================================
inline void saveAnnotationsDF(const AnnotationProject& project, const std::string& strPath) {
...
// ============================================================================
// 20260320 ZJH 加载 DeepForge 内部 JSON 格式标注
// 简化 JSON 解析（手动解析，不依赖 nlohmann_json 避免模块依赖）
// ============================================================================
inline AnnotationProject loadAnnotationsDF(const std::string& strPath) {
