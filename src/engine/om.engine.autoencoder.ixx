...
export module om.engine.autoencoder;
...
public:
    ...
    std::vector<Tensor*> buffers() override {
        ...
        append(m_encBn1.buffers());
        append(m_encBn2.buffers());
        append(m_encBn3.buffers());
        // 20260328 ZJH 解码器 BN 缓冲区
        append(m_decBn1.buffers());
        append(m_decBn2.buffers());
        return vecResult;
    }
    ...
    std::vector<std::pair<std::string, Tensor*>> namedBuffers(const std::string& strPrefix = "") override {
        ...
        // 20260328 ZJH 编码器 BN
        appendBufs("encBn1", m_encBn1);
        appendBufs("encBn2", m_encBn2);
        appendBufs("encBn3", m_encBn3);
        // 20260328 ZJH 解码器 BN
        appendBufs("decBn1", m_decBn1);
        appendBufs("decBn2", m_decBn2);
        return vecResult;
    }
