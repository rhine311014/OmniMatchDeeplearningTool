...
public:
    ...
    // nIn: 输入通道数
    // nOut: 输出通道数
    UNetEncoderBlock(int nIn, int nOut)
        : m_conv1(nIn, nOut, 3, 1, 1, true),   // 20260320 ZJH 第一层 3x3 卷积, pad=1, 有偏置
          m_conv2(nOut, nOut, 3, 1, 1, true),   // 20260320 ZJH 第二层 3x3 卷积, pad=1, 有偏置
...
private:
    ...
    ReLU m_relu;          // 20260320 ZJH ReLU 激活（无状态，共用）
};
...
public:
    ...
    UNet(int nInChannels = 1, int nNumClasses = 2)
        : m_enc1(nInChannels, 64),    // 20260320 ZJH 编码器第 1 层: nIn->64
          m_enc2(64, 128),            // 20260320 ZJH 编码器第 2 层: 64->128
          m_enc3(128, 256),           // 20260320 ZJH 编码器第 3 层: 128->256
          m_enc4(256, 512),           // 20260320 ZJH 编码器第 4 层: 256->512
          m_bottleneck(512, 1024),    // 20260320 ZJH 瓶颈层: 512->1024
